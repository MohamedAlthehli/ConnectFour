...
def process_move(p,b):
    ...
    a Player object p for the player whose move 
    is being processed, and a Board object b for
    ...
    if b.is_win_for(p.checker)==True:
        print(p_str,"wins in",p.num_moves,"moves.")
...
class RandomPlayer(Player):
    ...
    def next_move(self, b):
        "chooses at random from the available columns."
        lc = [x for x in range(b.width) if b.can_add_to(x)==True]
